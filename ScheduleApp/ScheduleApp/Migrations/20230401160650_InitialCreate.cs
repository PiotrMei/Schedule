        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ClientInformationsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Appointments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Appointments_Clients_ClientInformationsId",
                        column: x => x.ClientInformationsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ClientInformationsId",
                table: "Appointments",
                column: "ClientInformationsId");
